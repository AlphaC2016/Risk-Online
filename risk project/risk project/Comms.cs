...
namespace risk_project
{
    static class Comms
    {
        ...
        public const int GET_LEADERBOARDS = 230;
        public const int GET_LEADERBOARDS_RES = 231;
        ...
        public static void SendData(string message)
        {
            ...
            Stream streamOut = sc.OutputStream.AsStreamForWrite();
            streamOut.Write(buf, 0, buf.Length);
            streamOut.Flush();
        }
        ...
        public static int GetIntPartFromSocket(int size)
        {
            return int.Parse(RecvData(size));
        }
