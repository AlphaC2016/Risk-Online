...
namespace risk_project
{
    ...
    public sealed partial class LeaderboardsPage : Page
    {
        ...
        /* Leaderboards data format:
         * 
         * 131-count-namesize-name
         * message code: 3 bytes
         * username size: 2 bytes
         * username: size bytes
         * victories: 3 bytes
         * Example:
         * 13105alice007
        ...
        private string[,] GetData()
        {
            ...
            string request = Comms.GET_LEADERBOARDS.ToString();
            Comms.SendData(request);

            string rawData = Comms.RecvData(777);

            if (int.Parse(rawData.Substring(0,3)) == Comms.GET_LEADERBOARDS_RES)
            {
